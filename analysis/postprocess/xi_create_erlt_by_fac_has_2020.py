...
path_tti_com = (
    ...
    r"\Tasks\Task5_ Statewide_2020_AERR_EI\aedt_ems_2020"
    r"\bakFile_metricResults"
)

path_out_emis = Path.home().joinpath(PATH_PROCESSED, "emis_has_2020.xlsx")
path_out_flt = Path.home().joinpath(PATH_PROCESSED, "fleet_has_2020.xlsx")
