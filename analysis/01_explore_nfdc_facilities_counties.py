...
if __name__ == "__main__":
    ...
    nfdc_facilities_may21_1_fil = nfdc_facilities_may21_1.filter(
    ...
    assert all(
        nfdc_arpt_mrg.loc[~mask, "city_nfdc"] == nfdc_arpt_mrg.loc[~mask, "city_arpt"]
    )

    operation_date = nfdc_facilities_may21_1.operations_date.value_counts().sort_index()
