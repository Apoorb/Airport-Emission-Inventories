...
if __name__ == "__main__":
    path_com = Path(r"C:\Users\a-bibeka\PycharmProjects\airport_ei\data\external")
    ...
    eis_df_aetc_nan_2 = eis_df_aetc_nan_1.filter(
        items=[
            "state",
            "fips state code",
            "tribal name",
    ...
    eis_df_aetc_not_nan_iah = eis_df_aetc_not_nan.loc[
